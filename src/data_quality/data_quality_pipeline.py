...
def create_spark_session():
    ...
    spark = (
        SparkSession.builder.appName("SparkCity-DataQuality")
...
def assess_data_quality(df, dataset_name):
    ...
    return {"total_rows": total_rows, "total_cols": total_cols}
...
def test_pipeline():
    ...
    data = [("sensor1", 100, 65.5), ("sensor2", 150, 72.0), ("sensor3", 120, 68.5)]
...
try:
    ...
    spark = (
        SparkSession.builder.appName("SparkCity-Test").master("local[*]").getOrCreate()
    )
